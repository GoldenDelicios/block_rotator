...
#Change wrench mode
execute as @s[scores={RotationSuccess=0},nbt={Inventory:[{Slot:-106b, tag:{display:{Lore:['{"text":"Default"}']}}}]}] store result score @s RotationSuccess run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{RepairCost: 385438, CustomModelData: 2000000, HideFlags: 1, display: {Lore: ['{"text":"Flip"}'], Name: '{"italic":false,"text":"Etho\'s Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
execute as @s[scores={RotationSuccess=0},nbt={Inventory:[{Slot:-106b, tag:{display:{Lore:['{"text":"Flip"}']}}}]}] store result score @s RotationSuccess run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{RepairCost: 385438, CustomModelData: 3000000, HideFlags: 1, display: {Lore: ['{"text":"Face player"}'], Name: '{"italic":false,"text":"Etho\'s Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
execute as @s[scores={RotationSuccess=0},nbt={Inventory:[{Slot:-106b, tag:{display:{Lore:['{"text":"Face player"}']}}}]}] store result score @s RotationSuccess run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{RepairCost: 385438, CustomModelData: 4000000, HideFlags: 1, display: {Lore: ['{"text":"Face click"}'], Name: '{"italic":false,"text":"Etho\'s Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
execute as @s[scores={RotationSuccess=0},nbt={Inventory:[{Slot:-106b, tag:{display:{Lore:['{"text":"Face click"}']}}}]}] store result score @s RotationSuccess run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{RepairCost: 385438, CustomModelData: 5000000, HideFlags: 1, display: {Lore: ['{"text":"Terracotta mode"}', '{"text":"North"}'], Name: '{"italic":false,"text":"Etho\'s Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
execute as @s[scores={RotationSuccess=0}] store result score @s RotationSuccess run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{RepairCost: 385438, CustomModelData: 1000000, HideFlags: 1, display: {Lore: ['{"text":"Default"}'], Name: '{"italic":false,"text":"Etho\'s Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
