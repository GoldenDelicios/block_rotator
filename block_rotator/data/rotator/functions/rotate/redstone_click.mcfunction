...
execute as @s[scores={RotationSuccess=0}] run scoreboard players set @s RotationSuccess -2
execute unless score px RotationRaycast matches 1..14 run scoreboard players set @s RotationSuccess 0
execute unless score py RotationRaycast matches 1..14 run scoreboard players set @s RotationSuccess 0
execute unless score pz RotationRaycast matches 1..14 run scoreboard players set @s RotationSuccess 0
...
#Hopper
execute as @s[scores={RotationSuccess=0}] if score py RotationRaycast matches 15 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=down] replace minecraft:hopper
execute as @s[scores={RotationSuccess=0}] if score py RotationRaycast matches 10 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=down] replace minecraft:hopper
execute as @s[scores={RotationSuccess=0}] if score pz RotationRaycast matches 0 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=south] replace minecraft:hopper
execute as @s[scores={RotationSuccess=0}] if score px RotationRaycast matches 15 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=west] replace minecraft:hopper
execute as @s[scores={RotationSuccess=0}] if score pz RotationRaycast matches 15 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=north] replace minecraft:hopper
execute as @s[scores={RotationSuccess=0}] if score px RotationRaycast matches 0 store result score @s RotationSuccess run fill ~ ~ ~ ~ ~ ~ minecraft:hopper[facing=east] replace minecraft:hopper
...
#If block is repeater or comparator, face player
