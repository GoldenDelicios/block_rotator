...
execute as @s[scores={RotationSuccess=-1}] if block ~ ~ ~ #minecraft:rails unless block ~ ~-0.5 ~ #minecraft:rails unless block ~ ~ ~ minecraft:rail[shape=east_west] unless block ~ ~ ~ minecraft:rail[shape=north_south] unless block ~ ~ ~ minecraft:rail[shape=north_west] unless block ~ ~ ~ minecraft:rail[shape=north_east] unless block ~ ~ ~ minecraft:rail[shape=south_west] unless block ~ ~ ~ minecraft:rail[shape=south_east] unless block ~ ~ ~ minecraft:powered_rail[shape=east_west] unless block ~ ~ ~ minecraft:powered_rail[shape=north_south] unless block ~ ~ ~ minecraft:activator_rail[shape=east_west] unless block ~ ~ ~ minecraft:activator_rail[shape=north_south] unless block ~ ~ ~ minecraft:detector_rail[shape=east_west] unless block ~ ~ ~ minecraft:detector_rail[shape=north_south] run scoreboard players set @s RotationSuccess 0
execute as @s[scores={RotationSuccess=-1}] if block ~ ~ ~ #minecraft:rails unless block ~ ~-0.125 ~ #minecraft:rails run scoreboard players set @s RotationSuccess 0
