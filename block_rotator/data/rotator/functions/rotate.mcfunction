...
execute as @s[scores={RotationSuccess=0},nbt={Inventory:[{Slot:-106b, id:"minecraft:cactus"}]}] at @e[tag=RaycastResult] unless score DisableRedstoneFlip RotationConfig matches 1 run function rotator:rotate/redstone_flip
