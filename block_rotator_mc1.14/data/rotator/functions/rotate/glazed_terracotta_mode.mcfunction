...
replaceitem entity @s[tag=TerracottaNORTH] weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData: 5000000, RepairCost: 385438, HideFlags: 1, display: {Lore: ['{"text":"Terracotta mode"}', '{"text":"East"}'], Name: '{"italic":false,"text":"Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
replaceitem entity @s[tag=TerracottaEAST] weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData: 5000000, RepairCost: 385438, HideFlags: 1, display: {Lore: ['{"text":"Terracotta mode"}', '{"text":"South"}'], Name: '{"italic":false,"text":"Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
replaceitem entity @s[tag=TerracottaSOUTH] weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData: 5000000, RepairCost: 385438, HideFlags: 1, display: {Lore: ['{"text":"Terracotta mode"}', '{"text":"West"}'], Name: '{"italic":false,"text":"Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
replaceitem entity @s[tag=TerracottaWEST] weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData: 5000000, RepairCost: 385438, HideFlags: 1, display: {Lore: ['{"text":"Terracotta mode"}', '{"text":"North"}'], Name: '{"italic":false,"text":"Wrench"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}
